...
let handler = async (m, { conn, usedPrefix: _p, isOwner }) => {
  ...
  try {
    ...
    // Título de Soberano - Limpo e Majestoso
    let texto = `┏━ 👑 𝗠𝗘𝗡𝗨 𝗗𝗢𝗡𝗢 👑 ━┓\n\n`
    ...
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}update*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}exec*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}ofuscar*\n` // ADICIONADO AQUI
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}apagarmsg*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}antiprivado* [on/off]\n\n`

    texto += `⚡ 𝙁𝙀𝙍𝙍𝘼𝙈𝙀𝙉𝙏𝘼𝙎 𝙎𝙐𝙋𝙍𝙀𝙈𝘼𝙎\n`
    texto += `─━━━━┉❈⏤͟͟͞͞★꙲⃝͟⚙️❈┉━━━━─\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}rastrearip*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}comprimir*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}fake*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}hd*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}horario*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}ip*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}setmsg* [gatilho]\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}delmsg* [gatilho]\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}listmsg*\n\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}apagarmsg*\n\n`
...
texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}delprem*\n`
texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}listprem*\n`
texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}checkprem*\n\n`

    texto += `🏰 𝙂𝙐𝘼𝙍𝘿𝘼 𝘿𝙊 𝙍𝙀𝙄𝙉𝙊\n`
    texto += `─━━━━┉❈⏤͟͟͞͞★꙲⃝͟🛡️❈┉━━━━─\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}block*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}setppbot*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}rastrearip*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}leavegc*\n\n`
