...
let handler = async (m, { conn, usedPrefix: _p }) => {
  ...
  try {
    ...
    let texto = `┏━━ 🎮 𝗠𝗘𝗡𝗨 𝗝𝗢𝗚𝗢𝗦 🎮 ━━┓\n\n`
    
    texto += `*Que os jogos comecem!* ⚔️\n`
    texto += `Desafie sua mente e sua sorte com os mini-games da Gótica. 🦇\n\n`
...
┗━━━━⏤͟͟͞͞★꙲⃝͟🌙❈┉━━━━┛\n\n`
    ...
    texto += `🧩 𝘿𝙀𝙎𝘼𝙁𝙄𝙊𝙎 𝙈𝙀𝙉𝙏𝘼𝙄𝙎\n`
    texto += `─━━━━┉❈⏤͟͟͞͞★꙲⃝͟🧩❈┉━━━━─\n`
    texto += `┇┆🎲 ${_p}roleta\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}advinhacao*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}anagrama*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}forca*\n\n`

    texto += `🎲 𝙎𝙊𝙍𝙏𝙀 𝙀 𝘼𝙕𝘼𝙍\n`
    texto += `─━━━━┉❈⏤͟͟͞͞★꙲⃝͟🎲❈┉━━━━─\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}cassino*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}ppt* [pedra/papel/tesoura]\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}caraoucoroa*\n`
    texto += `ი ̯ ✦⋆͜͡҈➳ *${_p}tictactoe* [velha]\n\n`
    ...
    console.error(e);
    m.reply('❌ Erro ao abrir o menu de jogos.');
  }
};

handler.help = ['menujogos'];
handler.tags = ['main'];
handler.command = ['menujogos', 'jogos', 'games'];
